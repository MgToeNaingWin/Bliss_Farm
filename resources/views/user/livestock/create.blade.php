    ...
    <div class="py-10 bg-emerald-50/40 min-h-screen">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-emerald-950">မွေးမြူရေးတိရစ္ဆာန် အသစ်ထည့်သွင်းရန်</h2>
                    <p class="text-sm text-emerald-700 mt-1">အချက်အလက်များကို မှန်ကန်စွာ ဖြည့်စွက်၍ စာရင်းသွင်းပါ။</p>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-lg shadow-emerald-900/5 sm:rounded-2xl border border-emerald-100">
                <div class="p-6 sm:p-8">
                    <form method="POST" action="{{ route('user.livestock.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="notes" name="notes" rows="3"
                                          ...
                                          class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 transition duration-150">{{ old('notes') }}</textarea>
                            </div>
                        </div>
